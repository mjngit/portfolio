    ...
    <div>
      ...
      <div className="relative h-full w-full flex items-center justify-center" style={{ position: 'relative', height: '100%', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
        <div className="profileCard_container relative p-10 border-2 border-dashed rounded-full border-spacing-4 border-gray-400/50" style={{ position: 'relative', padding: '2.5rem', borderWidth: '2px', borderStyle: "dashed", borderRadius: '9999px', borderSpacing: '1rem 1rem'  }}>
          ...
          <button href="#/portfolio/homeV2" className="profile_item right-[45px] -top-[4px] absolute rounded-full bg-cover cursor-pointer border border-gray-400/50 p-[2px] active:scale-95 hover:scale-95 transition-all duration-500"  style={{ position: 'absolute', right: '50px', top: '4px', borderRadius: '999rem', className: 'tooltip', background: 'cover', cursor: 'pointer'}}>
            <span className="block w-[40px] h-[40px] transition-all duration-500 rounded-full z-[2] bg-white p-1">
          ...
          <button alt='Phone: 617-610-1869' className="profile_item right-[40%] -bottom-4 absolute rounded-full bg-cover cursor-pointer border border-gray-400/50 p-[2px] active:scale-95 hover:scale-95 transition-all duration-500 tooltip" style={{ position: 'absolute', bottom: '-.75rem', right: '45%' , borderRadius: '999rem', className: 'tooltip', background: 'cover', cursor: 'pointer'}}>
            <span className="block w-[40px] h-[40px] transition-all duration-500 rounded-full z-[2] bg-white p-1 ">
              <PhoneAndroidIcon/>
            </span>
          </button>
