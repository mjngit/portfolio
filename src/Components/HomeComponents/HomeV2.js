        ...
        <div className={isDarkMode ? 'dark-mode space-y-12 dark:bg-gray-800 dark:text-gray-100' : 'light-mode space-y-12 dark:bg-gray-800 dark:text-gray-100'} style={{marginTop: 12 }} >
            ...
            <header className="p-4" style={{padding: '2rem'}}>
                <div className="container flex justify-between h-16 mx-auto" id='container' style={{ display: 'flex', justifyContent:'space-between', height:'16px' }}>
                    <a rel="noopener noreferrer" href="#/portfolio/homeV2" aria-label="Back to homepage" className="flex items-center p-2" style={{display: 'flex', alignItems: 'center', padding: '2', color: 'blue' }}>
                        <CottageIcon />
                    </a>
                     <a rel="noopener noreferrer" href="/#/java/home" aria-label="Back to homepage" className="flex items-center p-2" style={{display: 'flex', alignItems: 'center', padding: '2', color: 'blue' }}>
                        <EmojiFoodBeverageIcon />
                    </a>
                     <a rel="noopener noreferrer" href="#/stackathon/fighters" aria-label="Back to homepage" className="flex items-center p-2 " style={{display: 'flex', alignItems: 'center', padding: '2', color: 'blue' }}>
                        <SportsKabaddiIcon />
                    </a>
                     <a rel="noopener noreferrer" href="#/stackathon/trip" aria-label="Back to homepage" className="flex items-center p-2" style={{display: 'flex', alignItems: 'center', padding: '2', color: 'blue' }}>
                        <FlightTakeoffIcon />
                    </a>
                     <a rel="noopener noreferrer" href="#/stackathon/present" aria-label="Back to homepage" className="flex items-center p-2" style={{display: 'flex', alignItems: 'center', padding: '2', color: 'blue' }}>
                        <CardGiftcardIcon />
                    </a>
                     <a rel="noopener noreferrer" href="#/capstone/home" aria-label="Back to homepage" className="flex items-center p-2" style={{display: 'flex', alignItems: 'center', padding: '2', color: 'blue' }}>
                        <ShowChartIcon />
                    </a>
