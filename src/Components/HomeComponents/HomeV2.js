    ...
    <>
        <div className={isDarkMode ? 'dark-mode space-y-12 dark:bg-gray-800 dark:text-gray-100' : 'light-mode space-y-12 dark:bg-gray-800 dark:text-gray-100'} style={{marginTop: 12 }} >
            ...
            <section className="py-6 dark:bg-gray-800 dark:text-gray-50" style={{ paddingTop: '1.5rem', paddingBottom: '1.5rem' }}>
                <div className="container flex flex-col justify-center p-4 mx-auto space-y-8 md:p-10 lg:space-y-0 lg:space-x-12 lg:justify-between lg:flex-row" style={{ display: 'flex', flexDirection: 'column', padding: ".75rem", marginLeft: '2rem', alignItems: 'center' }}>
                    <div className="flex flex-col space-y-4 text-center lg:text-left" style={{ display: 'flex', flexDirection: 'row', padding: ".75rem", marginLeft: '2rem', textAlign: 'left' }}>
            ...
            <section>
                <div className="container max-w-6xl p-6 space-y-6 sm:space-y-12" style={{ width: '72rem', padding: '1rem' }}>
                    ...
                    <div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3" style={{ display: 'grid', justifyContent: 'center', gap: '2rem', gridTemplateColumns: '450px, 450px ' }}>
            ...
            <footer>
                <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row" style={{ display: 'flex', flexDirection: 'row', padding: '1rem' }}>
                    ...
                    <div className="flex flex-col justify-center pt-6 lg:pt-0" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', paddingTop: '1.5rem' }} >
                        <div className="flex justify-center space-x-4" style={{ display: 'flex', justifyContent: 'center', paddingLeft: '2rem' }}>
                            <a rel="noopener noreferrer" href="https://www.instagram.com/numerounoabuelo/" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-lime-400 dark:text-gray-900" style={{ paddingLeft: '2rem'}}>
                                <InstagramIcon />
                            </a>
                            {/* Pinterest */}
                            ...
                            <a rel="noopener noreferrer" href="https://github.com/mjngit" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-lime-400 dark:text-gray-900" style={{ paddingLeft: '2rem'}}>
                                <GitHubIcon />                               
                            </a>

                            <a rel="noopener noreferrer" href="https://www.linkedin.com/in/mike-j-norris/" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-lime-400 dark:text-gray-900" style={{ paddingLeft: '2rem'}}>
                                <LinkedInIcon />
                            </a>
                            <button rel="noopener noreferrer" onClick={() => window.location = 'mailto:mnorris6@elon.edu'} className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-lime-400 dark:text-gray-900" style={{ paddingLeft: '2rem'}}>
                                <GoogleIcon />  
                            </button>
                        </div>
                    </div>
