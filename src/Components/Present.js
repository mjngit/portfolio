    ...
    return (
        <>
          ...
          <div>
                ...
                <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32" style={{display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', maxWidth: '720px', gap: '2rem', paddingTop: '2rem', paddingBottom: '4rem', paddingLeft: '2rem', paddingRight: '2rem', borderRadius: '1rem'}}>
